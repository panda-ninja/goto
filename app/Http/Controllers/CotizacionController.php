...
//        });
    ...
    public function proposals($id)
    {
        ...
        $cotizaciones = Cotizacion::with(['paquete_cotizaciones', 'cliente_cotizaciones' => function ($query) use ($idCliente) {
            $query->where('clientes_id', $idCliente);
        }])
            ->get()
            ->sortByDesc('fecha');
...
//       return dd($cotizaciones);
    ...
    public function guardar_cotizacion_paso2_edit(Request $request)
    {
