...
@section('content')
    ...
    <div id="todas" class="col s12 ">
        <ul class="collection">
            @foreach($cotizaciones->sortBy("updated_at") as $cotizacion)
                    ...
                    @if($cot)
                        ...
                        <li class="collection-item {{$bg_status}} {{$bg_hidden}}">
                            ...
                            <table class="table">
                                ...
                                @php $i = "A"; @endphp
                                @foreach($cotizacion->paquete_cotizaciones->sortBy("updated_at") as $paquete_cotizaciones)
                                    ...
                                    @elseif($cot->estado == 1 and $paquete_cotizaciones->estado > 0)
                                        @php
                                            switch ($paquete_cotizaciones->estado) {
                                                case '1':
                                                    $active = 'grey-text text-darken-3 bold-900';
