...
@section('content')
    ...
    <div class="row spacer-10">
        ...
        <form action="{{route('guardar_nuevo_paquete_path')}}" method="post">
            <div class="row">
                <div class="col s9">
                    <div class="row">
                        <div class="col s12">
                            <h5 class="grey-text text-darken-1">Nuevo paquete</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                <textarea id="icon_prefix2" name="incluye_txt" class="materialize-textarea"></textarea>
                                <label for="icon_prefix2" class="">Incluye</label>
                            </div>
                            <div class="input-field col s6">
                                <textarea id="incluye_txt" name="noincluye_txt" class="materialize-textarea"></textarea>
