...
@section('content')
    ...
    <div class="row spacer-10">
        <div class="col s12 center">
            <h4>Configuracion del paquete</h4>
            <p><b>Nombre:</b> Hidalgo | <b>Nro Pasajeros:</b> 2 | <b>Fecha de viaje:</b> 27 jun, 2017</p>
        </div>
    </div>
    <div class="row">
        <div class="col s12">
    ...
    <div class="row">
        <div class="col s12 valign-wrapper">
            <div class="input-field col s6">
                <input value="" id="first_name2" type="text" class="validate" placeholder="codigo o titulo del paquete">
