                ...
                @foreach($cotizaciones as $cotizacion)
                    @foreach($cotizacion->cliente_cotizaciones as $cliente_cotizacion)
                        @if($cliente_cotizacion)
                            ...
                            <tr class="{{$bgcolor}}">
                                <td>{{$i++}}</td>
                                    <td class="center"><a href="{{route('admin_proposals_path',$cliente_cotizacion->cliente->id)}}">{{$cliente_cotizacion->cliente->email}}</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="no-padding">
                                                <form class="formValidate" id="formValidate" method="post" action="{{route('cotizacion_crear_plann_path')}}">
                                                            ...
                                                            <a  href="javascript:;" onclick="parentNode.submit();" class="text-12 green-text padding-right-25">+propuestas</a>
