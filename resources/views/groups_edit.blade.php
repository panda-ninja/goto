        ...
        <form action="{{route('client_patch_path', $cliente->id)}}" class="col s12 font-moserrat" method="post">
            ...
            <div class="row">
                <div class="input-field col s6">
                    ...
                    <label for="nacionalidad_txt">Nationality</label>
                </div>
                <div class="input-field col s6">
                    ...
                    <label for="residencia_txt">City of Residence</label>
                </div>
            ...
            <div class="row">
                ...
                <div class="input-field col s12">
                    ...
                    <label for="comentarios_txt">Comments</label>
                </div>
            </div>
